      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="font-bold text-slate-900 dark:text-white hidden sm:block">QuotesMill</span>
          </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-3 animate-in slide-in-from-top-2 duration-300">
            ...
            <Link href="#pricing" className="block px-4 py-2 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors">
              Pricing
            </Link>
